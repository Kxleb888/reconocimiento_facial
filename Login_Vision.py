...
def registro_facial():
    ...
    def reg_rostro(img, lista_resultados):
        ...
        for i in range(len(lista_resultados)):
            ...
            cara_reg = cv2.resize(cara_reg,(300,300), interpolation = cv2.INTER_CUBIC) #Guardamos la imagen con un tamaño de 150x200
...
def pantalla_principal():
    ...
    Label(text = "Acceso a la Plataforma" "\n" "Bienvenido", bg = "#00008B", fg = "white" , width = "300", height = "2", font = ("Verdana", 13)).pack()#Asignamos caracteristicas de la ventana
